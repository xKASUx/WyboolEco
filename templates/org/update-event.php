...
<head>
	...
	<title>Обновление информации о мероприятии</title>
</head>
<body>
<style>
        #map {
...
<div class="min-h-screen bg-gray-100 p-0 sm:p-12">
  <div class="mx-auto max-w-md px-6 py-12 bg-white border-0 shadow-lg sm:rounded-3xl">
    <h1 class="text-2xl font-bold mb-8 text-center">Форма обновления информации о мероприятии</h1>
    <form id="form" method="POST" action="/events/update/<?= $event['event_id'] ?>" enctype="multipart/form-data">
